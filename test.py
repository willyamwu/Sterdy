...
# Specify the game date and NBA season
game_date = "2023-01-01"  # Replace with the desired date
nba_season = "2023"  # Replace with the desired season

# Get the scoreboard data for the specified date and season
scoreboard_data = scoreboard.Scoreboard(game_date=game_date, league_id='00', day_offset=0, game_date_utc='', season=nba_season)

# Retrieve the list of games
games = scoreboard_data.get_data_frames()[0]

# Assuming you want information about the first game, you can access it like this
first_game = games.iloc[0]

# Extract home and visiting teams
home_team = first_game['HOME_TEAM_NAME']
visitor_team = first_game['VISITOR_TEAM_NAME']

print(f"Home Team: {home_team}")
print(f"Visitor Team: {visitor_team}")
